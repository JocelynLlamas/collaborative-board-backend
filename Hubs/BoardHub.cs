    ...
    public class BoardHub : Hub
    {
        ...
        public override async Task OnDisconnectedAsync(Exception exception)
        {
            ...
            if (user != null)
            {
                ...
                AddToHistory("Disconnect", user.Username, $"{user.Username} has disconnected");
            }
        ...
        public async Task JoinBoard(string username)
        {
            ...
            await Clients.Caller.SendAsync("CurrentBoardState", BoardNotes, ConnectedUsers, new List<BoardAction>());

            // Registrar en el historial
            AddToHistory("Connect", username, $"{username} has joined the board");
        }
        ...
        public async Task DrawPoint(DrawPoint point)
        {
            ...
            {
                AddToHistory("Draw", user.Username, $"{user.Username} started a new stroke");
            }
        }
        ...
        public async Task AddNote(Note note)
        {
            ...
            if (user != null)
            {
                AddToHistory("AddNote", user.Username, $"{user.Username} added a note");
            }
        }
        ...
        public async Task UpdateNote(Note note)
        {
            ...
            if (existingNote != null)
            {
                ...
                if (user != null)
                {
                    AddToHistory("UpdateNote", user.Username, $"{user.Username} updated a note");
                }
            }
        }
        ...
        public async Task DeleteNote(string noteId)
        {
            ...
            if (note != null)
            {
                ...
                if (user != null)
                {
                    AddToHistory("DeleteNote", user.Username, $"{user.Username} deleted a note");
                }
            }
        }
        ...
        private void AddToHistory(string actionType, string username, string description)
        {
            ...
            Clients.All.SendAsync("ActionOccurred", action); // <-- Esto es lo que faltaba
        }
